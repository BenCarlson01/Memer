        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                usersDB.child(userID)
                        ...
                        .child(currentUID)
                        .setValue(true);
                makeToast(OldMainActivity.this, "Dislike!");
            }
            ...
            public void onRightCardExit(Object dataObject) {
                ...
                usersDB.child(userID)
                        ...
                        .removeValue();
                isMatch(userID);
                makeToast(OldMainActivity.this, "Like!");
            }
...
//                i++;
        ...
        flingContainer.setOnItemClickListener(new SwipeFlingAdapterView.OnItemClickListener() {
            ...
            public void onItemClicked(int itemPosition, Object dataObject) {
                makeToast(OldMainActivity.this, "Clicked!");
            }
        });
        ...
        connectionDB.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    makeToast(OldMainActivity.this, "New Match!");
    ...
    public void goToMatches(View view) {
        Intent intent = new Intent(OldMainActivity.this, MatchesActivity.class);
        startActivity(intent);
    }
}